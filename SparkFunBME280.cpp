...
uint8_t BME280::begin()
{
    ...
    SPI_A3_init(EUSCI_A_SPI_CLOCKSOURCE_SMCLK, 1000000L,
                EUSCI_A_SPI_PHASE_DATA_CHANGED_ONFIRST_CAPTURED_ON_NEXT, EUSCI_A_SPI_CLOCKPOLARITY_INACTIVITY_HIGH);
...
bool BME280::beginSPI(uint8_t csPin)
{
	...
	//Begin normal init with these settings. Should return chip ID of 0x58 for BMP
	//Begin normal init with these settings. Should return chip ID of 0x60 for BME
